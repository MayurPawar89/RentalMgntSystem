    ...
    class PartyMaster
    {
        ...
        public Int64 InsertUpdatePartyMaster()
        {
            ...
            try
            {
                ...
                oDBParameter.Add("@sPartyCode", this.sPartyName, ParameterDirection.Input, SqlDbType.VarChar);
                oDBParameter.Add("@sPartyName", this.sPartyCode, ParameterDirection.Input, SqlDbType.VarChar);
